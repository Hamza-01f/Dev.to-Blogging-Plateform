    ...
    <nav class="bg-gradient-to-r from-blue-600 to-indigo-600 p-4 shadow-lg">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="/app/view/AdmineDashboard/users/LogIn.php" class="flex items-center px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-300 shadow-md">
                    <i class="fas fa-sign-out-alt mr-2"></i>
                    Log In
                </a>
                <a href="/app/view/AdmineDashboard/users/Register.php" class="flex items-center px-4 py-2 bg-white text-indigo-600 rounded-lg hover:bg-gray-100 transition duration-300 shadow-md">
